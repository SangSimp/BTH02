...
namespace QuanLyBanHang.Forms
{
    public partial class frmSanPham : Form
    {
        ...
        private void frmSanPham_Load(object sender, EventArgs e)
        {
            ...
            bindingSource2.DataSource = sp;
            cboHangSanXuat.DataBindings.Clear();
            cboHangSanXuat.DataBindings.Add("SelectedValue", bindingSource2, "HangSanXuatID", false, DataSourceUpdateMode.Never);
            ...
            hinhAnh.Format += (s, ev) =>
            {
                if (ev.Value != null)
                {
                    ev.Value = System.IO.Path.Combine(imagesFolder, ev.Value.ToString());
                }
            };
        ...
        private void dataGridView1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            {
                // 1. Kiểm tra ô này có dữ liệu hay không
                if (e.Value != null && !string.IsNullOrWhiteSpace(e.Value.ToString()))
                {
                    string imagePath = System.IO.Path.Combine(imagesFolder, e.Value.ToString());

                    // 2. Kiểm tra xem file ảnh có thực sự tồn tại trong ổ cứng không
        ...
        private void btnDoiAnh_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                string uniqueFileName = fileName + "_" + DateTime.Now.Ticks.ToString() + ext;

                string fileSavePath = Path.Combine(imagesFolder, uniqueFileName);
