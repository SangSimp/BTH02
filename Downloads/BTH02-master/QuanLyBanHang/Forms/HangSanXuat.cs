...
namespace QuanLyBanHang.Forms
{
    public partial class frmHangSanXuat : Form
    {
        ...
        {
            if (MessageBox.Show("Xác nhận xóa hãng sản xuất này?", "Lỗi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                id = Convert.ToInt32(dataGridView.CurrentRow.Cells["ID"].Value.ToString());
                HangSanXuat hsx = context.HangSanXuat.Find(id);
                if (hsx != null)
        ...
        private void btnThoat_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Bạn có muốn thoát khỏi form?", "Thoát", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
